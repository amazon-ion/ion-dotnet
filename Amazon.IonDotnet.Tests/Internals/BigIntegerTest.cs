...
namespace Amazon.IonDotnet.Tests.Internals
{
    ...
    {
        private static readonly string largeInt3 =
        ...
        [TestMethod]
        public void TestLargeNegative1()
        {
            LargeIntTest("good/equivs/intsLargeNegative1.10n", "-18344837831112429282");
        }

        [TestMethod]
        public void TestLargePositive1()
        {
            LargeIntTest("good/equivs/intsLargePositive1.10n", "18344837831112429282");
        }

        [TestMethod]
        public void TestLargeNegative2()
        {
            LargeIntTest("good/equivs/intsLargeNegative2.10n", "-4696278484764781896429");
        }

        [TestMethod]
        public void TestLargePositive2()
        {
            LargeIntTest("good/equivs/intsLargePositive2.10n", "4696278484764781896429");
        }

        [TestMethod]
        public void TestLargeNegative3()
        {
            LargeIntTest("good/equivs/intsLargeNegative3.10n", "-" + largeInt3);
        }

        [TestMethod]
        public void TestLargePositive3()
        {
            LargeIntTest("good/equivs/intsLargePositive3.10n", largeInt3);
        }
